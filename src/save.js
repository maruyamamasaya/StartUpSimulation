...
export const deserializeGame = text => {
  ...
  return { ...state, ceoTrust: state.ceoTrust ?? 70, lowScoreStreak: state.lowScoreStreak ?? 0, decisionStreaks: state.decisionStreaks ?? { advertising: 0, discount: 0, hiring: 0, development: 0 } };
};
