...
export function createInitialState(rng = Math.random) {
  ...
  const price = 1200;
  return {
    month: 1, maxMonths: 24, cash, customers, revenue: customers * price, profit: 0,
    price, advertising: 100000, employees: 8, developmentLevel: 42,
    satisfaction: 67, churnRate: .045, brand: 28, scenario: null,
    monthsWithoutDevelopment: 0, dangerMonths: 0, gameOver: false, history: [],
    lastDecisions: { price, advertising: 100000, hires: 0, development: 150000 }
  };
}
